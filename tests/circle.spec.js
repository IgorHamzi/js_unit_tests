...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    const objetoRetornado = Object.keys(circle(1)).length;
    expect(objetoRetornado).toBe(3);
    ...
    const objetoPronto = { radius: 3, area: 28.259999999999998, circumference: 18.84 }
    expect(circle(3)).toEqual(objetoPronto);
  });
});
